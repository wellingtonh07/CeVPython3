def menu():
    ...
    try:
        ...
        print('\n\33[31;1mERRO! Opção não existe. Tente novamente...\33[m')
    else:
        if op == 1:
            sleep(1)
            listar_cadastros()
...
def listar_cadastros():
    ...
    arq_dados = open('ex115_módulo/database.txt', 'r', encoding='utf-8')
...
def cadastrar():
    ...
    arq_dados = open('ex115_módulo/database.txt', 'a', encoding='utf-8')  # Modo de escrita sem excluir conteúdo
    while True:
        try:
